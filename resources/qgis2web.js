...
map.getView().fit([-12533452.545881, 2589921.592558, -12018639.112437, 2943267.394672], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Metros cuadrados autorizados en el municipio de La Paz, BCS 2019-2024</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (198 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'mapa web para visualizar los m² autorizados en el municipio de La Paz en el periodo 2019-2024 a escala municipal por AGEB y localidad, y  dentro del ámbito de aplicación del PDUCP por AGEB y colonia';
            }
